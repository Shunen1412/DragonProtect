module.exports = (Dragon, messageReaction, user) => {
  ...
  if (["Dragon_Joie", "Dragon_Tristesse", "Dragon_Peur", "Dragon_Colere", "Dragon_Surprise", "Dragon_Degout"].includes(emoji) && message.channel.id === channel.id) {
    switch (emoji) {
      case "Dragon_Joie":
        member.roles.add(joieRole);
        break;
      case "Dragon_Tristesse":
        member.roles.add(tristesseRole);
        break;
      case "Dragon_Peur":
        member.roles.add(peurRole);
        break;
      case "Dragon_Colere":
        member.roles.add(colereRole);
        break;
      case "Dragon_Surprise":
        member.roles.add(surpriseRole);
        break;
      case "Dragon_Degout":
        member.roles.add(degoutRole);
        break;
    };
  };
}